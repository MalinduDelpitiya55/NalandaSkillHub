              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="review">
                    ...
                    <p>
                      If you are searching for minimal, unique and professional
                      logo design for your business, you are on the right place!
                    </p>
                    <p>
                      Get this extra offer and make your business great again 3
                      LOGO PROPOSAL + UNLIMITED REVISIONS + BUSINESS CARDS +
                      SOCIAL MEDIA FILES + LIFETIME INBOX SUPPORT FOR BEST PRICE
                      ON FIVERR!
                    </p>
