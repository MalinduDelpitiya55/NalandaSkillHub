      ...
      <div>
        ...
        <nav className="p-0 fixed-top text-white" id="top-nav">
          <div className="top-nav row mx-auto my-auto pt-3 pb-3 w-100 container-fluid text-white">
            <div
              className="toggle-btn col-auto text-white text-start p-0 d-md-none"
            ...
            <a
              href="/login"
              className="d-none d-sm-block text-white col-auto my-auto text-end fs-6 fw-semibold"
            >
              Sign In
            </a>
            <a href="/user"
        ...
        {/* Options nav */}
        <nav
          className="nav-options border-top border-bottom border-1 p-0 fixed-top d-none"
          id="nav-options"
        >
